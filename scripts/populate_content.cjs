// populate_content.cjs
// Node script (CommonJS) that overwrites every leaf markdown file (excluding index.md)
// under src/content/knowledge with generic formatted content.
