...
export const TOPICS: Topic[] = [
  {
    ...
    fullContent: 'Reversing diabetes focuses on restoring the body\'s sensitivity to insulin. At Nutrition Colours, Dr. Shilpa Thakur has designed a clinical circadian protocol that prioritizes non-starchy vegetables, clean protein, and healthy fats (avocado, nuts) to stabilize blood sugar. Completely eliminating refined sugar and timing meals with circadian rhythms help reset overall metabolic function and restore insulin sensitivity naturally.',
    ...
    pageTitle: 'Diabetes Reversal | Dr. Shilpa Thakur | Nutrition Colours',
    metaDescription: 'Learn how to reverse diabetes reversal naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
    primaryKeyword: 'Diabetes Reversal',
    clinicalReview: { reviewedBy: 'Dr. Shilpa Thakur', practitionerId: 'MD-CLN-7696', lastUpdated: '2026-06-03' },
    caseStudy: {
      title: 'Type 2 Remission Protocol',
      finding: 'Average HbA1c drop of 1.8 points within 90 days across 500+ participants.',
      narrative: 'A 52-year-old teacher reversed 12 years of diabetic history in just 6 months through Our protocol.'
    },
    faqs: [
      { question: "Can I eat whole fruit on this program?", answer: "Yes. Dr. Shilpa Thakur recommends selecting low-glycemic whole fruits like berries and apples, consumed in controlled portions during the active anabolic window at Nutrition Colours.", category: "Diet" },
      { question: "How quickly can I see blood sugar stabilization?", answer: "Many patients at Nutrition Colours observe glucose improvements within 7 to 14 days of starting the circadian diet protocol, under Dr. Shilpa's oversight.", category: "Timeline" },
      { question: "Do I have to stop all carbs?", answer: "No. The Nutrition Colours protocol focuses on complex, slow-digesting carbohydrates (like ragi or legumes) paired with healthy fats and fiber rather than complete carbohydrate elimination.", category: "Diet" },
    ]
  },
  {
    id: 'pcos-balance',
    title: 'PCOD/PCOS Balance',
    ...
    fullContent: 'This protocol addresses the root cause of ovarian dysregulation, which is often insulin resistance. Under the guidance of Dr. Shilpa Thakur at Nutrition Colours, patients focus on low-glycemic index (GI) foods, high fiber, and targeted supplements like Myo-Inositol to improve insulin sensitivity, reduce systemic inflammation, and restore natural hormonal balance.',
    naturalApproach: ['Low-GI foods', 'High fiber', 'Myo-Inositol', 'Reduced dairy'],
    image: '/images/nutritioncolours-default.svg',
    pageTitle: 'PCOD/PCOS Balance | Dr. Shilpa Thakur | Nutrition Colours',
    metaDescription: 'Learn how to reverse pcod/pcos balance naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
    primaryKeyword: 'PCOD/PCOS Balance',
    clinicalReview: { reviewedBy: 'Dr. Shilpa Thakur', practitionerId: 'MD-CLN-7696', lastUpdated: '2026-06-03' },
    caseStudy: {
    ...
    faqs: [
      { question: "Will this protocol help me get pregnant?", answer: "Yes. By addressing the root insulin resistance and lowering androgens, Dr. Shilpa's hormone protocols at Nutrition Colours have successfully helped many women restore regular ovulation and improve fertility.", category: "Fertility" },
      { question: "Is dairy allowed in the PCOS program?", answer: "Dr. Shilpa Thakur generally recommends eliminating processed commercial dairy during the initial healing phase at Nutrition Colours, as it contains hormones that can exacerbate insulin spikes.", category: "Diet" },
      { question: "Do I need to take birth control pills to regulate my periods?", answer: "Our goal at Nutrition Colours is to restore natural hormone production. Through circadian eating and weight management, we help patients regulate cycles without relying on synthetic hormones.", category: "Approach" },
    ]
  },
  {
    ...
    fullContent: 'Focuses on removing fat accumulation in the liver (NAFLD), primarily caused by excessive sugar and processed food intake. Under the guidance of Dr. Shilpa Thakur at Nutrition Colours, we completely eliminate refined sugars and high-fructose corn syrup while increasing intake of liver-supportive nutrients like choline to aid deep detoxification.',
    naturalApproach: ['Eliminate Fructose', 'Choline-rich foods', 'Garlic', 'Onions'],
    image: '/images/nutritioncolours-default.svg',
    pageTitle: 'Fatty Liver Reversal | Dr. Shilpa Thakur | Nutrition Colours',
    metaDescription: 'Learn how to reverse fatty liver reversal naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
    primaryKeyword: 'Fatty Liver Reversal',
    clinicalReview: { reviewedBy: 'Dr. Shilpa Thakur', practitionerId: 'MD-CLN-7696', lastUpdated: '2026-06-03' },
    caseStudy: {
      title: 'NAFLD Reversal Clinical Case',
      finding: 'FibroScan® scores improved from Grade 3 to Grade 1 within 180 days.',
    ...
    faqs: [
      { question: "Can fatty liver be completely reversed?", answer: "Yes. The liver is highly regenerative. Dr. Shilpa Thakur's protocols at Nutrition Colours have helped patients reverse Grade 2 and Grade 3 fatty liver within 3 to 6 months.", category: "Prognosis" },
      { question: "Are eggs good for fatty liver?", answer: "Yes. Eggs are an excellent source of choline, which is vital for transporting fats out of the liver. Dr. Shilpa recommends organic eggs as part of our metabolic plans.", category: "Diet" },
      { question: "Should I avoid all fats?", answer: "No. Healthy monounsaturated fats and Omega-3s support liver repair. Nutrition Colours focuses on removing processed trans fats and industrial seed oils instead.", category: "Nutrition" },
    ]
  },
  {
    ...
    image: '/images/nutritioncolours-default.svg',
    pageTitle: 'Thyroid Optimization | Dr. Shilpa Thakur | Nutrition Colours',
    metaDescription: 'Learn how to reverse thyroid optimization naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
    primaryKeyword: 'Thyroid Optimization',
    clinicalReview: { reviewedBy: 'Dr. Shilpa Thakur', practitionerId: 'MD-CLN-7696', lastUpdated: '2026-06-03' },
    caseStudy: {
    ...
    faqs: [
      { question: "Can I reduce my thyroid medication?", answer: "Many patients at Nutrition Colours are able to lower their dosage under medical supervision as thyroid cell function and gut conversion rates improve through Dr. Shilpa's protocols.", category: "Medication" },
  ...
  },
  {
    ...
    fullContent: 'Aims to lower blood pressure naturally to protect the heart and reduce stroke risk. At Nutrition Colours, Dr. Shilpa Thakur integrates the DASH diet framework, reducing refined sodium while boosting Potassium and Magnesium to naturally relax blood vessel walls and improve overall arterial elasticity.',
    naturalApproach: ['Low Sodium', 'High Potassium', 'Magnesium-rich foods', 'DASH Diet'],
    image: '/images/nutritioncolours-default.svg',
    pageTitle: 'Hypertension Management | Dr. Shilpa Thakur | Nutrition Colours',
    metaDescription: 'Learn how to reverse hypertension management naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
    primaryKeyword: 'Hypertension / High BP',
    clinicalReview: { reviewedBy: 'Dr. Shilpa Thakur', practitionerId: 'MD-CLN-7696', lastUpdated: '2026-06-03' },
    
    faqs: [
      { question: "Can I stop my BP pills on this diet?", answer: "Medication changes must always be supervised. However, Dr. Shilpa's sodium-potassium balancing protocols at Nutrition Colours have helped many patients taper off BP pills as their arteries relax.", category: "Medication" },
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse gut health & acidity naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse weight loss for women naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse weight loss for men naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse belly fat reduction naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse insulin resistance management naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
    ...
    faqs: [
      ...
      { question: "How long does it take to reverse insulin resistance?", answer: "With strict adherence to Dr. Shilpa's circadian protocols, insulin sensitivity begins improving within 30 days and can be fully reset in 90 days.", category: "Timeline" },
    ]
  },
  {
    ...
    category: CategoryType.METABOLIC,
    shortDesc: 'Act Now to Reverse Risk',
    ...
    fullContent: 'Identifies the critical window for reversal before Type 2 Diabetes develops. Under the clinical guidance of Dr. Shilpa Thakur at Nutrition Colours, we implement an intensive lifestyle intervention focusing on a diet high in fiber, low in processed sugars, and tracking blood glucose spikes.',
    ...
    metaDescription: 'Learn how to reverse pre-diabetes care naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse menopause hormone support naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse hormonal imbalance correction naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse testosterone boost naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse cortisol & stress balance naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse cholesterol management naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse heart health optimization naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse blood circulation support naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse joint pain relief naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse arthritis support naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse osteoporosis prevention naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse hyperthyroid protocol naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse muscle recovery & strength naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse back & spine health naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse hair growth & strength naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse skin glow & detox naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse anti-aging support naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse acne & skin clarity naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse nail health & strength naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse immunity boost naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse detox & rejuvenation naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse anti-inflammatory support naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse healthy aging solutions naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse wellness & longevity naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
    ...
    faqs: [
      ...
      { question: "Can lifestyle changes reverse cellular damage?", answer: "Yes. Restoring antioxidant pathways and sleep helps cells clear out damaged structures and repair DNA damage naturally.", category: "Prognosis" },
    ]
  },
  {
    ...
    metaDescription: 'Learn how to reverse fertility & hormone support naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
  ...
  },
  {
    ...
    metaDescription: 'Learn how to reverse pcos weight & diet naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
    ...
    faqs: [
      ...
      { question: "Can strength training help PCOS weight loss?", answer: "Yes. Muscle tissue burns glucose for fuel without needing insulin, helping reverse insulin resistance and speed up weight loss.", category: "Fitness" },
    ]
  },
  {
    ...
    metaDescription: 'Learn how to reverse menopause weight management naturally. Dr. Shilpa Thakur\'s clinical protocols at Nutrition Colours focus on circadian nutrition and root-cause metabolic repair.',
...
{ 
    ...
    fullContent: 'Reversing hyperuricemia requires addressing kidney filtration and systemic acidity. Under the clinical guidance of Dr. Shilpa Thakur at Nutrition Colours, we focus on alkalizing the body with hydration, tart cherry extract, and vitamin C-rich foods. Removing refined fructose and industrial seed oils helps lower inflammation and restore joint comfort.', 
    naturalApproach: ['Alkalizing hydration', 'Tart cherry extract', 'Low fructose', 'Limit purine foods'], 
    image: '/images/nutritioncolours-default.svg', 
    pageTitle: 'Uric Acid & Gout Reversal | Dr. Shilpa Thakur | Nutrition Colours', 
    metaDescription: 'Discover natural ways to reverse gout and lower uric acid. Read Dr. Shilpa Thakur\'s clinical guide on purine-flush diets at Nutrition Colours.', 
    primaryKeyword: 'Uric Acid Gout Reversal',
    clinicalReview: { reviewedBy: 'Dr. Shilpa Thakur', practitionerId: 'MD-CLN-7696', lastUpdated: '2026-06-03' },
    faqs: [
      ...
      { question: "Can uric acid be reversed permanently?", answer: "Yes, by repairing insulin resistance and kidney filtration efficiency through metabolic nutrition, permanent remission is highly achievable.", category: "Prognosis" }
    ]
  },
  { 
    id: 'chronic-fatigue-syndrome', 
    title: 'Chronic Fatigue Reversal', 
    ...
    fullContent: 'Chronic fatigue indicates a cellular energy crisis. At Nutrition Colours, Dr. Shilpa Thakur utilizes a chrononutrition approach to repair mitochondrial health. By integrating CoQ10-rich foods, magnesium, and reducing oxidative stress through an anti-inflammatory diet, we help patients reclaim their physical and mental vitality.', 
    naturalApproach: ['CoQ10 cofactors', 'Magnesium optimization', 'Circadian meal timing', 'Oxidative stress reduction'], 
    image: '/images/nutritioncolours-default.svg', 
    pageTitle: 'Chronic Fatigue Reversal | Dr. Shilpa Thakur | Nutrition Colours', 
    metaDescription: 'Reclaim your energy. Learn Dr. Shilpa Thakur\'s mitochondrial repair protocols for chronic fatigue at Nutrition Colours.', 
    primaryKeyword: 'Chronic Fatigue Reversal',
    clinicalReview: { reviewedBy: 'Dr. Shilpa Thakur', practitionerId: 'MD-CLN-7696', lastUpdated: '2026-06-03' },
    faqs: [
  ...
  { 
    ...
    clinicalReview: { reviewedBy: 'Dr. Shilpa Thakur', practitionerId: 'MD-CLN-7696', lastUpdated: '2026-06-03' },
    faqs: [
      { question: "Is muscle loss inevitable with age?", answer: "No. Sarcopenia can be prevented and reversed with adequate, clean protein intake and light resistance training, even in your 70s.", category: "Aging" },
