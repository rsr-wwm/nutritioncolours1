...
import { IconArrowRight, IconCheck, IconFlask, IconLock, IconMapPin } from '@/components/ui/Icons';
...
export default function PlanDetailPage() {
  const planSlug = 'cellular-resurrection';
    ...
    <div className="space-y-0">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 animate-in fade-in duration-1000 delay-300">
        <div className="bg-white rounded-[40px] shadow-2xl border border-stone-100 overflow-hidden">
          ...
          <div className="p-10 border-t border-stone-100"><FAQSection data={getDynamicCategoryFaqs('plans/cellular-resurrection', null)} title="Program Specific FAQs" /></div>
        </div>
