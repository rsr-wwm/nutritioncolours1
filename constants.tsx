...
import { CategoryType, TeamMember, Topic, BlogArticle, Recipe, Testimonial, FAQ, SitemapNode, HerbalEntity, MedicalConditionEntity, GenomicVariantEntity, DrugInteractionEntity } from './types';
...
Shift eating windows to focus meals during your active awake phase. Ensure you maintain a strict 12-hour fasting cycle before sleep to support metabolic recovery.`,
  ...
  {
    id: 'gut-brain-axis',
    title: 'Cure Anxiety & Brain Fog by Healing Your Gut',
  ...
  },
  {
    ...
    type: 'news',
    status: 'published',
    excerpt: 'Recognized for helping 5,000+ patients reverse diabetes naturally. Read about the award-winning protocol.',
    content: `Dr. Shilpa Thakur has been honored as the "Holistic Nutritionist of the Year." This award celebrates her unique protocol, which has helped thousands of patients stop their diabetes medication and live free of disease. It proves that with the right food, the body can heal anything.`,
    image: '/images/nutritioncolours-default.svg',
    tags: ['Awards', 'Press Release', 'Diabetes Cure'],
    date: 'Nov 10, 2023',
    author: 'Press Team'
  }
];
...
export const BANNERS = [
  {
    id: '1',
    title: 'We Believe You Can Heal Naturally',
    subtitle: 'We reject lifetime medication dependency. Our circadian-aligned biological food patterns coordinate with your natural biological clock to restore cellular health at the root cause.',
  ...
  },
  {
    ...
    subtitle: 'We reject the frustration of calorie-counting and generic diet plans. We treat food as biological information, aligning your metabolism with the sun for metabolic remission.',
    image: '/images/nutritioncolours-default.svg',
  ...
  },
  {
    ...
    subtitle: 'True health is the absence of daily health-management anxiety. We guide you to complete Type 2 Diabetes, PCOD, and Fatty Liver remission with evidence-based clinical protocols.',
    image: '/images/nutritioncolours-default.svg',
...
export const TEAM: TeamMember[] = [
  { 
    ...
    asl: 'F/42/Chandigarh', 
    socials: { 
      linkedin: 'https://linkedin.com/in/drthakurshilpa', 
      instagram: 'https://instagram.com/drthakurshilpa', 
      facebook: 'https://facebook.com/NutritionColours',
  ...
  { 
    ...
    fullBio: 'Kelive is a Food Recipe Expert and Celebrity Caterer with 7 years of specialized experience in creating delicious, healing meals. He ensures that therapeutic nutrition is not just effective but also a joy to eat, proving that medicine can indeed come from the kitchen.', 
  ...
  { 
    ...
    fullBio: 'Sangar Sharma is an Online Influencer and Fitness Trainer with 5 years of experience. He focuses on motivating and guiding clients through their lifestyle transformations, bridging the gap between clinical nutrition and daily fitness habits.', 
  ...
  { 
    ...
    fullBio: 'Nanz is a Yoga Specialist with 2 years of experience in therapeutic movement and mindfulness. Her sessions are designed to complement nutritional therapy by managing stress and improving the mind-body connection through traditional and modern yoga practices.', 
  ...
  { 
    id: 'rana', 
    name: 'R.S. Rana', 
    role: 'Business Consultant & Founder', 
    bio: 'Strategic lead overseeing global patient care operations.', 
    fullBio: 'Mr. R.S. Rana is a Strategic Business Consultant and Co-Founder of NutritionColours. He provides the operational and growth vision for the company, ensuring that Dr. Thakur\'s clinical protocols reach and help as many people as possible worldwide.', 
    details: 'Strategic Consultant, Co-Founder', 
    image: '/images/nutritioncolours-default.svg', 
...
export const MEMBER_SPECIFIC_FAQS: Record<string, FAQ[]> = {
  'shilpa': [
    ...
    { question: "Can I stop insulin?", answer: "Many of our patients have successfully tapered off insulin under doctor supervision as their natural blood sugar control improves.", category: "Medical" },
    ...
    { question: "Do you offer family consultations?", answer: "Yes, we often work with the whole family to ensure a supportive environment for metabolic reversal.", category: "Support" },
    { question: "What is your success rate?", answer: "Over 85% of patients who adhere to the protocol for 90 days see a significant reduction in medication dependency.", category: "Results" }
  ],
  'kelive': [
    ...
    },
    {
        ...
        children: [
            { 
              ...
              type: 'page', 
              status: 'optimized',
              meta: { title: 'Health Topics & Natural Cures | NutritionColours', description: 'Explore detailed, science-backed clinical nutrition articles covering various metabolic and autoimmune topics.', keywords: ['health topics', 'natural cures', 'metabolic syndrome', 'autoimmune'] },
              content: { benefits: ['Condition Guides', 'Research Summaries', 'Actionable Advice'], features: ['PCOS Guide', 'Diabetes Protocols', 'Thyroid Health'] }
            },
            { 
              id: 'blogs-page', 
              path: 'blogs', 
              ...
              type: 'page', 
              status: 'optimized',
              meta: { title: 'Clinical Insights Blog | NutritionColours', description: 'Read latest articles written by Dr. Shilpa Thakur on managing diseases using food as your medicine.', keywords: ['health blog', 'nutrition articles', 'food as medicine', 'dr shilpa thakur'] },
              content: { benefits: ['Latest Research', 'Success Stories', 'Diet Hacks'], features: ['Audio Versions', 'Printable Guides', 'Expert Interviews'] }
            },
            { 
              id: 'vegan-page', 
              path: 'vegan', 
              ...
              type: 'page', 
              status: 'optimized',
              meta: { title: 'Complete Vegan Clinical Guide | NutritionColours', description: 'How to practice therapeutic clinical nutrition on a 100% plant-based or vegan lifestyle.', keywords: ['vegan nutrition', 'plant based medicine', 'vegan clinical nutrition'] },
              content: { benefits: ['Plant-based Transition', 'Nutrient Optimization', 'Vegan Meal Plans'], features: ['Protein Charts', 'Supplement Guide', '100+ Vegan Recipes'] }
            },
            {
    ...
    },
    {
        ...
        children: [
            ...
            { 
              ...
              type: 'page', 
              status: 'optimized',
              meta: { title: 'Free Health Calculators & AI Tools | NutritionColours', description: 'Calculate your BMI, daily water needs, caloric deficit and even generate meals via AI.', keywords: ['health calculators', 'BMI tool', 'AI meal generator', 'calorie calculator'] },
              content: { benefits: ['Instant Results', 'Personalized Metrics', 'Data Driven'], features: ['AI Meal Planner', 'Water Tracker', 'Protein Calculator'] }
            },
            { 
              id: 'connect-page', 
              path: 'connect', 
    ...
    },
    {
        ...
        children: [
            ...
            { 
              ...
              type: 'page', 
              status: 'optimized',
              meta: { title: 'Our Clinical Team | Dr. Shilpa Thakur | NutritionColours', description: 'Meet the clinical medical nutritionists leading the metabolic reversal revolution.', keywords: ['clinical team', 'medical nutritionist', 'Dr. Shilpa Thakur'] },
              content: { benefits: ['Expert Care', 'Dedicated Practitioners', 'Certified Clinical Staff'], features: ['Staff Bios', 'Certifications', 'Consultation Booking'] }
            },
            { 
              id: 'history-page', 
              path: 'history', 
