...
export const MEDICAL_CONDITIONS_DATA: MedicalConditionEntity[] = [
  ...
  },
  {
    ...
    pageTitle: 'Insulin Resistance Management – Clinical Nutrition & Circadian Rhythm',
    metaDescription: 'Learn how to support insulin sensitivity naturally through circadian meal windows and specific nutrient timing under clinician supervision.',
    primaryKeyword: 'support insulin sensitivity naturally',
    clinicalReview: {
      reviewedBy: 'Dr. Shilpa Thakur',
      practitionerId: 'NUTR-SHILPA-001',
      lastUpdated: 'May 28, 2026',
