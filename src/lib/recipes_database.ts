...
Probiotic acidity: Raw ACV mother introducing beneficial bacteria.`,
  ...
  {
    id: 'mango-ginger-overnight-oats',
    title: 'Mango & Ginger Overnight Oats',
    category: 'Breakfast',
    image: 'https://images.unsplash.com/photo-1517673400267-0251440c45dc?q=80&w=800',
    tags: ['Digestion', 'Summer', 'Fiber'],
    prepTime: '10 mins + overnight soak',
    calories: '310',
    description: 'A Soaked-Oat Breakfast Bowl Pairing Beta-Glucan Fiber with Seasonal Mango.',
    healingDescription: 'Rolled oats soaked overnight in plant milk soften into a creamy base, topped with diced mango and a touch of fresh ginger — a fiber-forward breakfast that travels well.',
    ingredients: [
      { name: 'Oats', detail: '1/2 cup rolled' },
      { name: 'Mango', detail: '1/2 cup diced' },
      { name: 'Ginger', detail: '1/2 tsp grated' },
      { name: 'Almond Milk', detail: '3/4 cup' },
      { name: 'Chia Seeds', detail: '1 tbsp' }
    ],
    primaryBenefit: 'Digestive & Metabolic Support',
    fullHealingContent: `Oats (Beta-Glucan Fiber): Soluble fiber from oats forms a gel that slows gastric emptying, supporting a gentler post-meal glucose response and regularity.

Mango (Vitamin C & Carotenoids): Diced mango adds vitamin C and provitamin-A carotenoids; keep portions modest given its natural sugar content.

Ginger (Digestive Support): Fresh grated ginger is traditionally used to support digestion and may ease post-meal bloating.

Overnight Soak: Soaking softens the oat structure and shortens morning prep, without needing any cooking.`,
    preparedBy: 'Nutrition Colours Dr. Shilpa Thakur'
  },
  {
    id: 'pomegranate-ragi-porridge',
    title: 'Pomegranate Ragi Porridge Bowl',
    category: 'Breakfast',
    image: 'https://images.unsplash.com/photo-1517093157656-b9eccef01cb1?q=80&w=800',
    tags: ['Calcium', 'Gluten-Free', 'Metabolic'],
    prepTime: '20 mins',
    calories: '280',
    description: 'A Calcium-Rich, Gluten-Free Porridge from South India\'s Signature Millet.',
    healingDescription: 'Finger millet (ragi) is simmered into a warm porridge and finished with fresh pomegranate arils and a pinch of cinnamon — a traditional South Indian breakfast reimagined.',
    ingredients: [
      { name: 'Ragi', detail: '1/2 cup flour' },
      { name: 'Pomegranate', detail: '1/4 cup arils' },
      { name: 'Cinnamon', detail: '1/4 tsp ground' },
      { name: 'Milk or plant milk', detail: '1 cup' },
      { name: 'Jaggery', detail: '1 tsp (optional)' }
    ],
    primaryBenefit: 'Bone Health & Gluten-Free Nutrition',
    fullHealingContent: `Ragi (Finger Millet): Among the richest plant-based dietary calcium sources of any commonly eaten grain, and naturally gluten-free.

Pomegranate (Polyphenols): Fresh arils add fiber and punicalagin polyphenols, along with a pop of texture and tartness.

Cinnamon: Used traditionally to add warmth and flavor without added sugar.

Preparation Note: Toasting the ragi flour briefly before adding liquid deepens its nutty flavor and helps prevent lumps.`,
    preparedBy: 'Nutrition Colours Dr. Shilpa Thakur'
  },
  {
    id: 'watermelon-mint-cooler',
    title: 'Watermelon Mint Hydration Cooler',
    category: 'Beverage',
    image: 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?q=80&w=800',
    tags: ['Hydration', 'Summer', 'Low-Calorie'],
    prepTime: '10 mins',
    calories: '65',
    description: 'A Low-Calorie, Lycopene-Rich Cooler for Hot-Weather Hydration.',
    healingDescription: 'Blended watermelon and fresh mint, strained lightly, make a refreshing, naturally sweet cooler that is over 90% water by weight.',
    ingredients: [
      { name: 'Watermelon', detail: '2 cups cubed' },
      { name: 'Mint', detail: '8-10 leaves' },
      { name: 'Lime', detail: '1/2 juiced' },
      { name: 'Chia Seeds', detail: '1 tsp (optional)' }
    ],
    primaryBenefit: 'Hydration Support',
    fullHealingContent: `Watermelon (Hydration & Lycopene): About 91% water by weight, watermelon is a practical hot-weather hydration source and a dietary source of the carotenoid lycopene.

Mint: Adds aromatic freshness and is traditionally used to settle the stomach after meals.

Lime: A splash of acidity balances the natural sweetness and adds a small amount of vitamin C.

Serving Note: Despite watermelon's high glycemic index, its low carbohydrate density per serving keeps glycemic load modest — enjoy a standard 1-2 cup portion.`,
    preparedBy: 'Nutrition Colours Dr. Shilpa Thakur'
  },
  {
    id: 'jowar-roti-curry-leaf-tempering',
    title: 'Jowar Roti with Curry Leaf Tempering',
    category: 'Main',
    image: 'https://images.unsplash.com/photo-1596797038530-2c107229654b?q=80&w=800',
    tags: ['Gluten-Free', 'Metabolic', 'Traditional'],
    prepTime: '30 mins',
    calories: '220',
    description: 'A Gluten-Free Flatbread Staple from the Deccan Plateau, Finished with a Classic Tempering.',
    healingDescription: 'Sorghum (jowar) flour is hand-rolled into flatbread and served with a fragrant curry leaf and mustard seed tempering — a traditional Maharashtrian and Karnataka staple.',
    ingredients: [
      { name: 'Jowar', detail: '1 cup flour' },
      { name: 'Curry Leaves', detail: '8-10 leaves' },
      { name: 'Mustard Seeds', detail: '1/2 tsp' },
      { name: 'Turmeric', detail: '1/4 tsp' },
      { name: 'Ghee or Oil', detail: '1 tbsp' }
    ],
    primaryBenefit: 'Gluten-Free Staple Nutrition',
    fullHealingContent: `Jowar (Sorghum): A naturally gluten-free whole grain suitable as a wheat substitute, with a fiber and polyphenol profile that compares favorably to refined wheat flour.

Curry Leaves: A South Indian tempering staple traditionally used for both flavor and digestive support.

Mustard Seeds & Turmeric: The tempering (tadka) technique — briefly frying whole spices in hot ghee or oil — develops flavor while using only a small amount of fat.

Rolling Tip: Jowar dough is gluten-free and less elastic than wheat — roll between parchment sheets and cook on a hot tawa for the best texture.`,
    preparedBy: 'Nutrition Colours Dr. Shilpa Thakur'
  },
  {
    id: 'papaya-turmeric-smoothie-bowl',
    title: 'Papaya Turmeric Smoothie Bowl',
    category: 'Breakfast',
    image: 'https://images.unsplash.com/photo-1495214783159-3503fd1b572d?q=80&w=800',
    tags: ['Anti-inflammatory', 'Low-Calorie', 'Digestion'],
    prepTime: '10 mins',
    calories: '190',
    description: 'A Low-Energy-Density Bowl Pairing Papain-Rich Papaya with Golden Turmeric.',
    healingDescription: 'Frozen papaya blends into a thick, naturally sweet base, finished with a pinch of turmeric and black pepper to support absorption of its curcumin.',
    ingredients: [
      { name: 'Papaya', detail: '1 cup frozen, cubed' },
      { name: 'Banana', detail: '1/2 frozen' },
      { name: 'Turmeric', detail: '1/4 tsp ground' },
      { name: 'Black Pepper', detail: 'pinch' },
      { name: 'Coconut Milk', detail: '1/4 cup' }
    ],
    primaryBenefit: 'Low-Calorie Density & Anti-Inflammatory Support',
    fullHealingContent: `Papaya (Papain & Vitamin C): Low energy density with high vitamin C makes papaya a useful choice in weight-aware diets; it also contains the enzyme papain.

Turmeric & Black Pepper: Pairing turmeric with black pepper's piperine is a well-known combination for improving curcumin absorption.

Banana: Adds creaminess and natural sweetness without needing added sugar.

Serving Tip: Freeze papaya and banana chunks ahead of time for a thicker, ice-cream-like texture without added sugar.`,
    preparedBy: 'Nutrition Colours Dr. Shilpa Thakur'
  },
  {
    id: 'bajra-khichdi-garlic-tempering',
    title: 'Bajra Khichdi with Garlic Tempering',
    category: 'Main',
    image: 'https://images.unsplash.com/photo-1606491956689-2ea866880c84?q=80&w=800',
    tags: ['Iron-Rich', 'Gluten-Free', 'Comfort Food'],
    prepTime: '35 mins',
    calories: '340',
    description: 'An Iron-Dense, One-Pot Millet & Lentil Comfort Bowl.',
    healingDescription: 'Pearl millet (bajra) is simmered with split lentils into a soft, one-pot khichdi, finished with a garlic and cumin tempering — a winter staple across western and northern India.',
    ingredients: [
      { name: 'Bajra', detail: '1/2 cup' },
      { name: 'Split Lentils', detail: '1/4 cup' },
      { name: 'Garlic', detail: '3 cloves, minced' },
      { name: 'Cumin', detail: '1 tsp seeds' },
      { name: 'Ghee', detail: '1 tbsp' }
    ],
    primaryBenefit: 'Iron-Rich Comfort Nutrition',
    fullHealingContent: `Bajra (Pearl Millet): A notably iron-dense cereal, naturally gluten-free, with a lower glycemic index than refined wheat or white rice.

Split Lentils: Combined with bajra, lentils round out the amino acid profile for a more complete plant protein meal.

Garlic & Cumin Tempering: A hot-oil tempering (tadka) of garlic and cumin seeds develops deep flavor while keeping added fat modest.

Preparation Note: Bajra benefits from a short soak (30-60 minutes) before cooking to soften the grain and shorten cooking time.`,
    preparedBy: 'Nutrition Colours Dr. Shilpa Thakur'
  },
  {
    id: 'guava-mint-fresh-salad',
    title: 'Guava & Mint Fresh Salad',
    category: 'Salad',
    image: 'https://images.unsplash.com/photo-1536511132770-e5058c7e8c46?q=80&w=800',
    tags: ['Vitamin C', 'High-Fiber', 'Low-Sugar'],
    prepTime: '10 mins',
    calories: '95',
    description: 'A High-Fiber, Low-Sugar Fruit Salad Built Around Winter Guava.',
    healingDescription: 'Sliced guava is tossed with fresh mint, a squeeze of lime, and a pinch of chaat masala — a simple, fiber-forward way to enjoy one of the most vitamin-C-dense common fruits.',
    ingredients: [
      { name: 'Guava', detail: '2 medium, sliced' },
      { name: 'Mint', detail: '6-8 leaves, torn' },
      { name: 'Lime', detail: '1/2 juiced' },
      { name: 'Chaat Masala', detail: 'pinch' }
    ],
    primaryBenefit: 'Vitamin C & Fiber Density',
    fullHealingContent: `Guava (Vitamin C & Fiber): Among the richest common dietary sources of vitamin C, with a high fiber-to-sugar ratio that makes it a favorable fruit choice for blood-sugar-aware eating.

Mint: Fresh mint leaves add aroma and a traditional digestive pairing with fruit chaats.

Lime & Chaat Masala: A classic Indian fruit-salad finish that adds brightness without needing added sugar.

Serving Note: Guava's low glycemic index (~12) and high fiber content make it a favorable low-glycemic-load fruit choice.`,
    preparedBy: 'Nutrition Colours Dr. Shilpa Thakur'
  },
  {
    id: 'barley-pineapple-detox-bowl',
    title: 'Barley & Pineapple Digestive Bowl',
    category: 'Salad',
    image: 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?q=80&w=800',
    tags: ['Digestion', 'Fiber', 'Low-GI'],
    prepTime: '30 mins (barley pre-cooked)',
    calories: '260',
    description: 'A Low-Glycemic Grain Bowl Pairing Beta-Glucan-Rich Barley with Bromelain-Rich Pineapple.',
    healingDescription: 'Cooked pearled barley is tossed with fresh pineapple, mint, and a light lime dressing — one of the lowest-glycemic-index common grains paired with a tropical fruit known for its digestive enzyme.',
    ingredients: [
      { name: 'Barley', detail: '3/4 cup cooked' },
      { name: 'Pineapple', detail: '1/2 cup diced' },
      { name: 'Mint', detail: '5-6 leaves' },
      { name: 'Lime', detail: '1/2 juiced' },
      { name: 'Olive Oil', detail: '1 tsp' }
    ],
    primaryBenefit: 'Low-Glycemic Fiber & Digestive Support',
    fullHealingContent: `Barley (Beta-Glucan): Among the lowest-glycemic-index common cereal grains, driven by its unusually high beta-glucan and total fiber content.

Pineapple (Bromelain & Vitamin C): A source of vitamin C, manganese, and the enzyme bromelain, which has documented anti-inflammatory activity mainly at supplemental doses.

Mint & Lime: A light, bright dressing that lets the barley and pineapple textures stand out.

Serving Tip: Cook barley in advance and refrigerate — like rice, cooling cooked barley increases resistant starch.`,
    preparedBy: 'Nutrition Colours Dr. Shilpa Thakur'
  }
];
