...
Shift eating windows to focus meals during your active awake phase. Ensure you maintain a strict 12-hour fasting cycle before sleep to support metabolic recovery.`,
  ...
  {
    id: 'telehealth-metabolic-consulting',
    title: 'Virtual Telehealth Nutrition: Evidence-Based Remote Care',
    category: CategoryType.METABOLIC,
    type: 'blog',
    status: 'published',
    excerpt: 'How remote clinical nutrition consulting delivers structured metabolic guidance, continuous biomarker review, and circadian meal plans from home.',
    content: `Modern clinical nutrition care no longer requires physical clinic visits. Through encrypted telehealth consultations, continuous dietary logging, and external diagnostic biomarker tracking (HbA1c, fasting insulin, lipid panels), patients across India and globally receive individualized metabolic care from home.`,
    image: '/images/nutritioncolours-default.svg',
    tags: ['Telehealth', 'Remote Nutrition', 'Clinical Care'],
    date: 'Jan 15, 2024',
    author: 'Dr. Shilpa Thakur',
    pageTitle: 'Virtual Telehealth Nutrition Consulting | NutritionColours',
    metaDescription: 'Discover how remote clinical nutrition consulting delivers structured metabolic guidance, biomarker reviews, and circadian meal plans.',
    primaryKeyword: 'virtual telehealth nutrition'
  },
  {
    id: 'circadian-nutrition-framework',
    title: 'The Circadian Nutrition Framework: Aligning Meal Timing with Metabolic Clocks',
    category: CategoryType.METABOLIC,
    type: 'blog',
    status: 'published',
    excerpt: 'Exploring the science of chrononutrition: why when you eat matters just as much as what you eat for insulin sensitivity.',
    content: `Chrononutrition investigates the bidirectional interaction between biological circadian rhythms and nutritional metabolism. Aligning energy intake with the active daylight phase optimizes peripheral clock gene expression in the liver, pancreas, and adipose tissue, supporting glycemic control and lipid homeostasis.`,
    image: '/images/nutritioncolours-default.svg',
    tags: ['Chrononutrition', 'Circadian Rhythms', 'Insulin Sensitivity'],
    date: 'Feb 10, 2024',
    author: 'Dr. Shilpa Thakur',
    pageTitle: 'Circadian Nutrition Framework & Meal Timing | NutritionColours',
    metaDescription: 'Explore the science of chrononutrition and learn how aligning meal timing with biological clocks optimizes insulin sensitivity and metabolic health.',
    primaryKeyword: 'circadian nutrition framework'
  }
];
...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    idealFor: 'Type 2 Diabetes Support & Remission',
    image: '/images/precision_metabolic_nutrition_dr_shilpa.webp',
    icon: 'IconLock',
    color: 'teal',
    description: 'Cellular Resurrection is our most intensive clinical nutrition program focused on supporting clinical remission of Type 2 Diabetes. This protocol aggressively targets insulin sensitivity at the cellular level to help restore pancreatic health under senior clinician supervision.',
    features: [
