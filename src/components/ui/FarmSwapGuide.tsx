...
export const FarmSwapGuide = () => {
  ...
  return (
    <div className="glass-panel-premium p-8 rounded-[40px] h-full flex flex-col justify-between">
      <div className="space-y-4">
        <div>
          <span className="badge-clinical">GEO & AEO Optimizer</span>
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="region-selector" className="form-label">Select Outreach Zone</label>
          <select 
            id="region-selector"
            value={region} 
        ...
        <div className="p-4 bg-accent rounded-2xl border border-default">
        ...
        <div className="space-y-3 pt-2">
          ...
          <div className="space-y-2">
            {data.swaps.map(s => (
              <div key={s.original} className="bg-stone-50 dark:bg-emerald-900/10 p-3 rounded-xl border border-divider flex justify-between items-start gap-4">
