...
export const GeospatialMap: React.FC<GeospatialMapProps> = ({
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      // Update hovered pin state safely using ref tracking to avoid stale closures
      if (currentHovered !== hoveredPinRef.current) {
        hoveredPinRef.current = currentHovered;
  ...
  }, [sphereDots, selectedCountry, circadianPhase]);
    ...
    <div ref={containerRef} className="relative w-full max-w-[340px] aspect-square flex items-center justify-center select-none">
      ...
      {hoveredPin && (
        <div
          ...
          className="glass-panel-premium p-4 rounded-2xl w-60 text-xs space-y-2 pointer-events-none animate-in fade-in zoom-in-95 duration-150"
        >
