        ...
        <div className="grid lg:grid-cols-12 gap-12 mb-12 items-start">
          <div className="lg:col-span-8 space-y-6">
            <div className="flex items-center gap-3 flex-wrap">
              <span className="px-4 py-1.5 bg-emerald-50 text-emerald-800 text-[10px] font-black uppercase tracking-widest rounded-full">Clinical {herb.category} Profile</span>
              <span className="text-xs font-mono text-stone-500 italic">{herb.scientificName}</span>
              <a href="#clinical-evidence-table" className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 text-emerald-800 border border-emerald-100 text-[9px] font-black uppercase tracking-widest hover:bg-emerald-100 transition-colors">
  ...
  <div className="animate-in fade-in duration-700 min-h-screen bg-stone-50/30 pb-24 pt-32">
    <div className="max-w-7xl mx-auto px-6">
      ...
      <div className="grid lg:grid-cols-12 gap-12 mb-12"><div className="lg:col-span-8 space-y-6">
          {/* Breadcrumb label */}
          <div className="flex items-center gap-3 flex-wrap">
            <span className="px-4 py-1.5 bg-emerald-50 text-emerald-800 text-[10px] font-black uppercase tracking-widest rounded-full">Nutrigenomics · SNP Profile</span>
            <span className={`px-4 py-1.5 text-[10px] font-black uppercase tracking-widest rounded-full ${variant.genotype.includes('High Risk') ? 'bg-red-50 text-red-700' : variant.genotype.includes('Moderate') ? 'bg-amber-50 text-amber-700' : 'bg-emerald-50 text-emerald-700'}`}>{variant.genotype.includes('High Risk') ? '⚠ High Risk Variant' : variant.genotype.includes('Moderate') ? '⚡ Moderate Risk' : '✓ Low Risk Variant'}</span>
          </div>
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            <div className="flex items-center gap-2 px-4 py-2 bg-stone-100 rounded-xl border border-stone-200">
