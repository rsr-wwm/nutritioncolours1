...
import { IconBot, IconX, IconSearch, IconMapPin, IconArrowRight, IconFileText, IconSettings } from './Icons';
import { TEAM, PLANS, BLOG_ARTICLES } from '../constants';
import { RECIPES } from '../recipes_database';
import { TOPICS } from '../topics';
import { clearStoredGeminiApiKey, getStoredGeminiApiKey, setStoredGeminiApiKey } from './apiKey';
...
const playAudio = async (text: string) => {
  try {
    ...
    if (!apiKey) {
      console.warn("TTS skipped: Gemini API Key is not set.");
      return;
    }
