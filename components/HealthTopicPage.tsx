...
import { TOPIC_SPECIFIC_FAQS, CATEGORY_FAQS } from '../constants';
import { TOPICS } from '../topics';
import { IconLeaf, IconCheck, IconArrowRight, IconShieldCheck, IconFlask, IconActivity, IconX, IconUser, IconMapPin } from './Icons';
  ...
  if (!topic) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 text-center">
        <h2 className="text-3xl font-black text-emerald-950 brand-font mb-4">Topic Not Found</h2>
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-8 space-y-12">
          ...
          <div className="bg-stone-50 rounded-3xl border border-stone-100 overflow-hidden shadow-sm">
             <div className="p-5 bg-stone-100/50 border-b border-stone-100">
                <h3 className="text-xs font-black uppercase tracking-widest text-emerald-950">Protocol Summary Data</h3>
             </div>
          ...
          <section className="bg-stone-50/50 dark:bg-emerald-900/10 rounded-[40px] border border-stone-200 dark:border-emerald-800 shadow-sm overflow-hidden animate-in fade-in duration-500 mb-12">
            <div className="bg-emerald-950 text-white p-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-stone-200 dark:border-emerald-800">
              <div className="space-y-1">
                ...
                <h3 className="text-xl font-black brand-font">
            ...
            <section className="bg-white border-2 border-emerald-900/10 rounded-[40px] p-10 relative overflow-hidden">
              ...
              <div className="space-y-6">
                 ...
                 <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                       <h4 className="text-xs font-black uppercase tracking-widest text-emerald-600">Observation & Narrative</h4>
                    ...
                    <div className="p-6 bg-emerald-50 rounded-3xl border border-emerald-100 flex flex-col justify-center">
                       <h4 className="text-xs font-black uppercase tracking-widest text-emerald-600 mb-2">Key Clinical Finding</h4>
        ...
        <aside className="lg:col-span-4 space-y-8">
          ...
          <div className="bg-white p-8 rounded-[40px] border border-stone-100 shadow-xl sticky top-28">
            <h4 className="text-xl font-black text-emerald-950 brand-font mb-4">Start Your Recovery</h4>
          ...
          {TOPICS.filter(t => t.category === topic.category && t.id !== topic.id).slice(0, 4).map(related => (
            ...
            >
              ...
              <div>
                ...
                <h4 className="font-black text-emerald-950 group-hover:text-emerald-600 transition-colors text-sm uppercase tracking-tight line-clamp-2">{related.title}</h4>
              </div>
            </a>
          ))}
        </div>
