...
import { IconWand, IconPlate, IconLeaf, IconCoffee, IconSun, IconMoon, IconSave, IconRefresh, IconTrash, IconCheck } from './Icons';
...
export const SmartMealGenerator = ({ activeLocation }: { activeLocation?: any }) => {
  ...
  const generatePlan = async () => {
    ...
    try {
      ...
      console.error("Meal Gen Error", e);
