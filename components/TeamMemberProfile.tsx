...
import { IconArrowLeft, IconLinkedIn, IconTwitter, IconInstagram, IconMapPin, IconCheck, IconFacebook } from './Icons';
import { Accordion } from './Accordion';
import { MEMBER_SPECIFIC_FAQS } from '../constants';
           ...
           <div>
            ...
            {member.id === 'shilpa' && (
               <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
                  ...
                  <div className="bg-blue-50 p-6 rounded-3xl border border-blue-100 flex flex-col items-center justify-center text-center col-span-2 md:col-span-1">
                      <IconFacebook size={24} className="text-blue-600 mb-2" /> {/* Render Facebook icon for Facebook stat */}
